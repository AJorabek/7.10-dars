...
import { Layout, Menu, Button, theme, Form, Select, Input, Table } from "antd";
        ...
        >
          <div className="content">
            <div className="first-wrapper">
              <div>
                <h3 style={{ marginBottom: 10 }}>Sinf:</h3>
                <Form.Item
                  label="Select"
                  style={{
                    width: 200,
                ...
                >
                  <Select>
                    <Select.Option value="5-sinf">5-sinf</Select.Option>
                    <Select.Option value="6-sinf">6-sinf</Select.Option>
                    <Select.Option value="7">7-sinf</Select.Option>
                    <Select.Option value="8-sinf">8-sinf</Select.Option>
                    <Select.Option value="9-sinf">9-sinf</Select.Option>
                    <Select.Option value="10-sinf">10-sinf</Select.Option>
                    <Select.Option value="11-sinf">11-sinf</Select.Option>
                  </Select>
                </Form.Item>
              </div>
              <Button style={{ marginTop: 30 }}>Clear</Button>
            </div>
